...
- `adding to linked list:` Almost the same as adding two numbers in a list (but in this case we use two linked list. Take care of the remainder when using the modulus operation.)
